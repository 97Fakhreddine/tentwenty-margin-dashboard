  ...
  return (
    <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white">
      <div className="border-b border-zinc-200 px-6 py-4">
        <h2 className="font-semibold text-zinc-950">Project profitability</h2>

        <p className="mt-1 text-sm text-zinc-500">Ranked by margin</p>
      </div>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-zinc-100">
            {projects.map((project) => (
              <tr key={project.referenceCode} className="hover:bg-zinc-50">
                ...
                <td className="px-4 py-4 text-right tabular-nums">
                  {formatCurrencyAed(project.revenueAed)}
                </td>

                <td className="px-4 py-4 text-right tabular-nums">
                  {project.costAed === null
                    ? "—"
